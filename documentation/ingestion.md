# 🟩 Ingestion Subsystem — System Design Deep Dive

---

## 🎯 Zone Responsibility Reminder

Ingestion has one sacred job:

> Reach into Signal Sources, collect every signal, normalize it into one unified format, and deliver it downstream — **reliably, completely, and without coupling the rest of the system to any source**
...
The bridge between Ingestion and Pipeline.
...
14. Pipeline (Processing Pipeline) consuming from Event Bus
```
...
Signal Sources never bleeds into Pipeline.
