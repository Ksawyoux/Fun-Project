...
Signal Sources is **not** an active part of the system.

This is a critical distinction:

> Signal Sources is the **external world** the system observes.
> Ingestion (Ingestion) reaches into Signal Sources to pull signals.

Signal Sources itself does nothing.
...
This is the most important insight about Signal Sources:
...
## ⚠️ Signal Sources Gaps & Blind Spots
...
## 🧠 Mental Model for Signal Sources

> Think of Signal Sources as a city being observed by different sensors:
