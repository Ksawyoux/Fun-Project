...
type Pipeline struct {
	...
	z4  *storageclient.Client
}

func New(reg *registry.Registry, z4 *storageclient.Client) *Pipeline {
	return &Pipeline{
		reg: reg,
		z4:  z4,
	}
...
func (p *Pipeline) Process(ctx context.Context, batch *nif.Batch) ([]storageclient.Mutation, error) {
	if batch == nil {
		return nil, nil
	}
