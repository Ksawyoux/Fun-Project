...
The reasoning brain that sits on top of Storage. Translates structural and
...
Requires a Storage daemon already running.

```
go run ./cmd/servingd -zone4 http://localhost:8080 -addr :8081
