...
func ComputeEvolution(ctx context.Context, cl *storageclient.Client, namespace string, from, to time.Time) (*EvolutionReport, error) {
	entries, err := cl.ReadLog(ctx, storageclient.ReadLogOpts{Limit: 1000})
	if err != nil {
...
func entryMatchesNamespace(e storageclient.LogEntry, namespace string) bool {
...
func relationshipDriftAlert(e storageclient.LogEntry) *DriftAlert {
	if e.AfterState == nil {
		return nil
	}
