...
import (
	...
	"archgraph/serving/internal/analytics"
	"archgraph/serving/internal/assembler"
	"archgraph/serving/internal/intent"
	"archgraph/serving/internal/planner"
...
func (s *Server) handleGetEntity(w http.ResponseWriter, r *http.Request) {
	...
	if depthStr != "" {
		...
		nb, err := s.cl.Neighborhood(r.Context(), id, depth, storageclient.DirBoth)
		if err != nil {
			writeClientErr(w, err)
			return
		}
...
func (s *Server) handleReadLog(w http.ResponseWriter, r *http.Request) {
	var opts storageclient.ReadLogOpts
